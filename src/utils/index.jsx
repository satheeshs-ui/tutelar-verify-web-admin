...
export const showWarning = (data) => {
  const message =
    typeof data === "string" ? data : (data?.message ?? "Warning");
...
export const getDateFromTimeZones = (
  dateString,
  formatDateTime,
  offsetTime,
) => {
...
export const getStatus = (status, from) => {
  ...
  let classes =
    (normalizedStatus && statusClassMap[normalizedStatus]) || defaultClass;
