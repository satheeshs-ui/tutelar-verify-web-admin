    ...
    <div className='flex gap-4 flex-wrap items-center justify-between py-3 px-4 max-[500px]:border-none border border-primary-grey-3 bg-white rounded-full'>
      <div className='flex items-center gap-2'>
        <button
          ...
          className='cursor-pointer px-1 py-1 !text-[10px] gap-3 !sm:text-[12px] font-medium !text-[#6A7174]   hover:bg-gray-50 disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:bg-white flex items-center gap-1 transition-colors'
        >
          <ChevronLeft size={16} />
        </button>
        ...
        <button
          ...
          className='cursor-pointer px-1 py-1 !text-[#6A7174]  !text-[10px] !sm:text-[12px] font-medium   hover:bg-gray-50 disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:bg-white flex items-center gap-1 transition-colors'
        >
