...
export const TopModal = ({ isOpen, onClose, children, closeBtn }) => {
    ...
    return (
        <div className="modal-overlay" onClick={() => !closing && onClose()}>
            <div
                className={`modal-box ${closing ? "slide-out" : "slide-in"}`}
