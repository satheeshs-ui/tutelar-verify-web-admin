...
export const PrimaryButton = ({
    ...
    return (
        <button
            type={htmlType}
            className={`flex items-center justify-center px-6 w-full py-3 overall-button rounded-3xl ${
                disabled
                    ? "bg-primary-black-12 cursor-not-allowed text-gray-500 opacity-60"
                    : "bg-primary cursor-pointer text-[#FFFFFF]!"
            } text-base transition font-normal ${className} text-[14px]`}
            style={customstyle}
