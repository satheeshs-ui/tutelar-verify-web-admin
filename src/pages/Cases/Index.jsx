...
import { checkValue, getStatusColors, removeUnderScore, shouldShowPagination } from "../../utils";
...
const CaseList = () => {
    ...
    const handleCallConnect = (e, u) => {
        ...
        const scheduledTime = u?.scheduledDateTime ? new Date(u.scheduledDateTime) : null;
    ...
    useEffect(() => {
        ...
        return () => clearHeader();
    }, [clearHeader, setHeader, navigate, reviewStatus, caseStatus, search, selectType, dateRange]);
                                        ...
                                        return (
                                            <div
                                                ...
                                                onClick={() =>
                                                    isCompleted &&
                                                    navigate(
                                                        `/cases/cases-list/report/${u?.caseId}`
                                                    )
                                                }
                                            >
                                                {checkValue(u?.caseId)}
                                    ...
                                    render: (u) => (
                                        <div className="text-gray-900 font-normal flex">
                                            ...
                                            u.caseStatus !== "expired" ? (
                                                ...
                                                <Tooltip title="Link no longer available">
                                                    -
                                                </Tooltip>
                                            )}
                                        </div>
