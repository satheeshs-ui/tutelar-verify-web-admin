...
import { checkValue, returnSimpleFormatedDate, shortName, shouldShowPagination } from "../../utils";
...
const UserList = () => {
    ...
    const { getUserList, userList, updateUser, isLoading, unblockUserAccount } = useUserStore();
    ...
    const accountinfo = [
        ...
        {
            label: "Created At",
            value: userDetails?.createdAt ? returnSimpleFormatedDate(userDetails?.createdAt) : "-",
        },
        {
            label: "Created By",
            ...
            <div className="">
                ...
                {isLoading ? (
                    ...
                    <>
                        ...
                        {openModal && (
                            <ModalPopUp isOpen={openModal} onClose={handleClose} closeBtn={false}>
