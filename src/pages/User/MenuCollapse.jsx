          ...
          `}
                >
                    <div className="flex items-center gap-3">
                        <span className="text-sm font-medium text-[#111928] max-[500px]:text-[12px]">
                            {parent.menuName}
                        </span>
                    </div>
                    ...
                    {childMenus.map((child, cIndex) => (
                        <div key={child.menuId} className="py-3">
                            <Checkbox
                                ...
                                className="
        [&_.ant-checkbox-checked_.ant-checkbox-inner]:bg-blue-600
        [&_.ant-checkbox-checked_.ant-checkbox-inner]:border-blue-600
