...
const ClientCreate = multiLazy(
  () => import("../pages/Client/components/AddEdit/ClientCreate.jsx"),
);

const DesignationList = multiLazy(
  () => import("../pages/Designation/Index.jsx"),
);

const DepartmentList = multiLazy(
    () => import("../pages/Department/Index.jsx"),
)
const router = createBrowserRouter([
...

  {
    ...
    children: [
      ...
      {
        path: "/clients-list/create-client",
        element: <ClientCreate />,
      },
      {
        path: "/clients-list/edit-client/:clientId",
        element: <ClientCreate />,
      },
      {
        path: "/designations/designations-list",
