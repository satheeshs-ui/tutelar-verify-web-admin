...
const ForgotPassword = multiLazy(() => import("../pages/Login/Content/ForgotPassword"));
const ResetPassword = multiLazy(() => import("../pages/Login/Content/ResetPassword"));
const AuthenticationPage = multiLazy(() => import("../pages/Login/Content/AuthenticationPage"));
const OtpVerificationPage = multiLazy(() => import("../pages/Login/Content/OtpVerification"));
...
const AgentDetailPage = multiLazy(() => import("../pages/Agent/components/AgentDetailPage.jsx"));
...
const AddEditAgentFormPage = multiLazy(() => import("../pages/Agent/AddEditAgentFormPage.jsx"));
...
const HistoryList = multiLazy(() => import("../pages/DownloadManager/HistoryList"));
const MeetScreen = multiLazy(() => import("../pages/CallScreen/MeetScreen.jsx"));
const DocConfiguration = multiLazy(() => import("../pages/DocConfiguration/Index.jsx"));
...
const AddEditUserFormPage = multiLazy(() => import("../pages/User/AddEditUserFormPage.jsx"));
...
const router = createBrowserRouter([
...

    {
        ...
        children: [
            ...
            { path: "/cases/cases-list/report/:caseId", element: <KYCVerificationReport /> },
            { path: "/agents/agents-list/edit-agent/:agentId", element: <AddEditAgentFormPage /> },
            { path: "/agents/agents-list/create-agent", element: <AddEditAgentFormPage /> },
            { path: "/agents/agents-list/view-agent/:userId", element: <AgentDetailPage /> },
...
export default function AppRouter() {
    ...
    return (
        <Suspense fallback={<LottieLoader lottieKey="loaderIcon" playerClass="w-[80px]" />}>
